...
function FillData(){
	...
	success: function (returnPayload, retJson) {		
		if(retJson == "success"){
			 var Datas = JSON.parse(returnPayload);										
			 $('#txtFname').val() = Datas.FirstName
			 $('#txtLname').val() = Datas.LastName
			 $('#txtAge').val() = Datas.Age		 
			 $('#txtNum').val() = Datas.Number;
			 $('#txtEmail').val() = Datas.Email;		 
			 $('#PassInput').val() = Datas.Password;
			 $('#AccTypeInput option:selected').text() = Datas.AccountType;
			 $('#UNameInput').val() = Datas[i].UName = Datas.UName;
			 $('#CityDDL option:selected').text() = Datas.City;
			 $('#StateDDL option:selected').text() = Datas.State;
		}
	}	
	});
}	
